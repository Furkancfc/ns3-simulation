...
void AdjustTxPowerAlongPath (Ptr<Node> senderNode, Ipv4Address destAddress, NodeContainer &nodes, Ipv4InterfaceContainer &interfaces)
{
    ...
    // Simulator::Schedule(Seconds(1.0),&AdjustTxPowerAlongPath,senderNode,destAddress,&nodes,&interfaces);
}
...
int main (int argc, char *argv[])
{
    ...
    Simulator::Schedule (Seconds (1.0), &AdjustTxPowerAlongPath, nodes.Get (0), interfaces.GetAddress (nodes.GetN () - 1), std::ref (nodes), std::ref (interfaces));
