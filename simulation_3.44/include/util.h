...
ns3::DataRate CalculateTxDataRate(ns3::Ptr<ns3::Node> sNode, ns3::Ptr<ns3::Node> rNode);
ns3::DataRate CalculateRxDataRate(ns3::Ptr<ns3::Node> sNode, ns3::Ptr<ns3::Node> rNode);
